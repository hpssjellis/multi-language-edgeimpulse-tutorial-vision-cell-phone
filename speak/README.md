...
<h1> Vanilla Javascript Lightning Talk Pech Kucha Markdown HTML README.md</h1>
...
<input  type="button" value="Speak Page5" onclick="{  
    console.log(google.translate.pageLanguage();  
}"> 

<input  type="button" value="Speak Page6" onclick="{  
    console.log(google.translate.TranslateElement.pageLanguage();  
}"> 
<br><br>
 ...
 <input type=button value="Mr. Ellis Reading English with AutoScroll" onclick="{ 
...
<h3><a href="#1">1</a> </h3>
<h2>Make a Vision Classification (unknown and pen) EdgeImpulse Machine Learning model using your cell phone before using the Arduino ML Kit. </h2>

First login or signup to <a href="https://edgeimpulse.com/">edgeImpulse.com</a> and then create a new Project<br>
...
<h3><a href="#4">4</a>  </h3>
<h2>Edge Impulse Web App Data Collection: Label Unknown </h2>
...
<h3><a href="#5">5</a>  </h3>
<h2>Edge Impulse Web App Data Collection: Label Pen </h2>
<br>
...
<h3><a href="#6">6</a>  </h3>
<h2>Data Acquisition and Labels </h2>

Select Data Acquisition. <br> 
...
<h3><a href="#7">7</a>  </h3>
<h2>Design your Impulse (Machine Learning Model) </h2>
Select Design Impulse <br>
...
<h2>Check your data, on EdgeImpulse with the testing dataset. </h2>
Choose Live Classification <br> 
...
<h3><a href="#11">11</a>  </h3>
<h2>Check you data using your cell phone loaded with the EdgeImpulse Web App </h2>
...
<h3><a href="#12">12</a>  </h3>
<h2>Check you data using EdgeImpulse WASM (Web Assembly Language) </h2>
...
<h3><a href="#14">14</a>  </h3>
<h2>Check you data using Rocksetta index.html and EdgeImpulse WASM </h2>
...
<a href="#top">Top of page</a>
 ...
 ##<h2>By Jeremy Ellis Twitter <a href="https://twitter.com/rocksetta">@Rocksetta </a> Use at your own Risk!


  <h2>By Jeremy Ellis Twitter @Rocksetta Use at your own Risk!</h2>
Note when looking at the markdown none of the javascript buttons appear, you must go to your Gitpages Demo Link!<br>
A few Javascript abilites do not work, such as hiding the code. So all the Javascript not in buttons is below. <br>

Note: <ol>
<li> Old ML presentation [here](https://hpssjellis.github.io/my-robotics-machine-learning-teaching-lightning-talk-pecha-kucha/)
<li> Old TensorflowJS presentation [here](https://hpssjellis.github.io/lightening-talk-Pecha-Kucha-tensorflowjs/)
<li> Teacher Presentation Feedback [here](https://hpssjellis.github.io/jeremy-ellis-tinyML-teacher-feedback-2022/)
<li> Pecha Kucha template [here](https://github.com/hpssjellis/pecha-kucha-lightning-talks-template)
  </ol><br><br>
